...
# It requires the -AdminName parameter is passed with the ym\username admin cred. 
...
#Attributes
$DirsyncServer = "srv-stp-dc03.corp.yourmembership.com"  # FQDN of the Dirsync Server
